 ...
 */
final class Version20251021133230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD author_id INT NOT NULL, CHANGE enabled published TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP author_id, CHANGE published enabled TINYINT(1) NOT NULL');
    }
}
